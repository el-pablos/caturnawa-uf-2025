...
class CompetitionDetailSeeder extends Seeder
{
    ...
    private function createDCCCompetition()
    {
        try {
            $competition = Competition::create([
                ...
                'early_bird_deadline' => Carbon::create(2025, 1, 31, 23, 59, 59),
                'max_participants' => 150,
                'max_team_members' => 3,
                'min_team_members' => 1,
                'registration_start' => Carbon::create(2025, 1, 1, 0, 0, 0),
                'registration_end' => Carbon::create(2025, 2, 28, 23, 59, 59),
                'competition_start' => Carbon::create(2025, 3, 15, 8, 0, 0),
                'competition_end' => Carbon::create(2025, 3, 17, 17, 0, 0),
                'submission_start' => Carbon::create(2025, 3, 1, 0, 0, 0),
                'submission_end' => Carbon::create(2025, 3, 14, 23, 59, 59),
                'judging_start' => Carbon::create(2025, 3, 18, 8, 0, 0),
                'judging_end' => Carbon::create(2025, 3, 25, 17, 0, 0),
                'announcement_date' => Carbon::create(2025, 3, 30, 14, 0, 0),
                'is_active' => true,
    ...
    private function createEDCCompetition()
    {
        $competition = Competition::create([
            ...
            'early_bird_deadline' => Carbon::create(2025, 1, 25, 23, 59, 59),
            'max_participants' => 64,
            'max_team_members' => 3,
            'min_team_members' => 3,
            'registration_start' => Carbon::create(2025, 1, 15, 0, 0, 0),
            'registration_end' => Carbon::create(2025, 2, 15, 23, 59, 59),
            'competition_start' => Carbon::create(2025, 3, 1, 8, 0, 0),
            'competition_end' => Carbon::create(2025, 3, 3, 17, 0, 0),
            'submission_start' => null,
            'submission_end' => null,
            'judging_start' => Carbon::create(2025, 3, 1, 8, 0, 0),
            'judging_end' => Carbon::create(2025, 3, 3, 17, 0, 0),
            'announcement_date' => Carbon::create(2025, 3, 3, 19, 0, 0),
            'is_active' => true,
            'is_team_competition' => true,
    ...
    private function createKDBICompetition()
    {
        $competition = Competition::create([
            ...
            'early_bird_deadline' => Carbon::create(2025, 2, 20, 23, 59, 59),
            'max_participants' => 48,
            'max_team_members' => 3,
            'min_team_members' => 3,
            'registration_start' => Carbon::create(2025, 2, 1, 0, 0, 0),
            'registration_end' => Carbon::create(2025, 3, 15, 23, 59, 59),
            'competition_start' => Carbon::create(2025, 3, 20, 8, 0, 0),
            'competition_end' => Carbon::create(2025, 3, 22, 17, 0, 0),
            'submission_start' => null,
            'submission_end' => null,
            'judging_start' => Carbon::create(2025, 3, 20, 8, 0, 0),
            'judging_end' => Carbon::create(2025, 3, 22, 17, 0, 0),
            'announcement_date' => Carbon::create(2025, 3, 22, 19, 0, 0),
            'is_active' => true,
            'is_team_competition' => true,
            'allow_individual' => false,
            'rules' => json_encode([
    ...
    private function createSPCCompetition()
    {
        $competition = Competition::create([
            ...
            'early_bird_deadline' => Carbon::create(2025, 2, 28, 23, 59, 59),
            'max_participants' => 100,
            'max_team_members' => 3,
            'min_team_members' => 1,
            'registration_start' => Carbon::create(2025, 1, 1, 0, 0, 0),
            'registration_end' => Carbon::create(2025, 3, 31, 23, 59, 59),
            'competition_start' => Carbon::create(2025, 4, 15, 8, 0, 0),
            'competition_end' => Carbon::create(2025, 4, 17, 17, 0, 0),
            'submission_start' => Carbon::create(2025, 3, 1, 0, 0, 0),
            'submission_end' => Carbon::create(2025, 4, 10, 23, 59, 59),
            'judging_start' => Carbon::create(2025, 4, 11, 8, 0, 0),
            'judging_end' => Carbon::create(2025, 4, 14, 17, 0, 0),
            'announcement_date' => Carbon::create(2025, 4, 17, 16, 0, 0),
            'is_active' => true,
            'is_team_competition' => true,
            'allow_individual' => true,
            'rules' => json_encode([
    ...
    private function createInfografisCompetition()
    {
        $competition = Competition::create([
            ...
            'price' => 75000,
            'early_bird_price' => 60000,
            'early_bird_deadline' => Carbon::create(2025, 2, 15, 23, 59, 59),
            'max_participants' => 100,
            'max_team_members' => 2,
            'min_team_members' => 1,
            'registration_start' => Carbon::create(2025, 2, 15, 0, 0, 0),
            'registration_end' => Carbon::create(2025, 3, 15, 23, 59, 59),
            'competition_start' => Carbon::create(2025, 4, 1, 8, 0, 0),
            'competition_end' => Carbon::create(2025, 4, 3, 17, 0, 0),
            'submission_start' => Carbon::create(2025, 3, 16, 0, 0, 0),
            'submission_end' => Carbon::create(2025, 3, 30, 23, 59, 59),
            'judging_start' => Carbon::create(2025, 4, 4, 8, 0, 0),
            'judging_end' => Carbon::create(2025, 4, 10, 17, 0, 0),
            'announcement_date' => Carbon::create(2025, 4, 12, 14, 0, 0),
            'is_active' => true,
            'is_team_competition' => true,
            'allow_individual' => true,
            'rules' => json_encode([
