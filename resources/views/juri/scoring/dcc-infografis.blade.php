...
@section('title', 'DCC Infografis Scoring')
...
<div class="container-fluid py-4">
    ...
    <div class="mb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-2">
                ...
                <li class="breadcrumb-item active">DCC Infografis</li>
            </ol>
        </nav>
        <h1 class="h3 mb-1">DCC Infografis Scoring</h1>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="mb-0">{{ $submission->created_at->format('d M Y') }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="mb-1">Infografis File</h6>
                ...
                <a href="{{ Storage::url($submission->file_path) }}" target="_blank" class="btn btn-primary">
                    <i class="bi bi-download me-2"></i>Download / View
                </a>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('juri.scoring.submit', $submission->id) }}" method="POST">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                @php
                    $criteria = \App\Models\Score::getDccInfografisCriteria($stage);
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <textarea name="comments" 
                          class="form-control" 
                          rows="5" 
                          placeholder="Provide detailed feedback on the infografis...">{{ old('comments', $existingScore->comments ?? '') }}</textarea>
            </div>
        </div>
