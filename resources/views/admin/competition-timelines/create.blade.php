...
@section('title', 'Create Competition Timeline')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Create New Timeline Event</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ route('admin.competition-timelines.store') }}" method="POST">
                @csrf
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save"></i> Create Timeline Event
                    </button>
