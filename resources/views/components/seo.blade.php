...
{{-- Security Headers --}}
<meta http-equiv="Content-Security-Policy" content="default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://unpkg.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://code.jquery.com https://cdn.datatables.net https://app.midtrans.com https://app.sandbox.midtrans.com https://d2f3dnusg0rbp7.cloudfront.net *.cloudfront.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://unpkg.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://cdn.datatables.net; font-src 'self' https://fonts.gstatic.com https://cdn.jsdelivr.net https://cdn.datatables.net; img-src 'self' data: https: blob: https://d2f3dnusg0rbp7.cloudfront.net *.cloudfront.net; connect-src 'self' https://api.midtrans.com https://api.sandbox.midtrans.com https://app.midtrans.com https://app.sandbox.midtrans.com https://www.google-analytics.com http://localhost:* ws://localhost:* https://d2f3dnusg0rbp7.cloudfront.net *.cloudfront.net; frame-src 'self' https://app.midtrans.com https://app.sandbox.midtrans.com https://www.google.com; object-src 'none'; base-uri 'self'; form-action 'self'">
