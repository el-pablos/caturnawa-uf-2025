...
<body>
    ...
    <nav class="peserta-sidebar" id="peserta-sidebar">
        <div class="position-sticky">
            <!-- Brand -->
            <div class="peserta-brand px-3 py-3 border-bottom border-light border-opacity-25" style="display: flex; align-items: center; gap: 8px;">
                <i class="bi bi-person-badge me-2 text-light"></i>
                Portal Peserta
            </div>
            ...
            <div class="nav-menu-container flex-grow-1 overflow-auto" style="max-height: calc(100vh - 120px); scrollbar-width: thin;">
                <div class="nav nav-pills flex-column p-3">
                    ...
                    <!-- Logout Button -->
                    <a href="#" class="nav-link text-white" id="logout-link-sidebar" onclick="handleLogout(event)" style="margin-top: 1rem; border: 1px solid rgba(255, 255, 255, 0.3); background-color: darkred;">
