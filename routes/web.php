...
// NOTE: API routes have been moved to routes/api.php to avoid middleware conflicts
// The routes below were causing authentication issues for public API endpoints
// All API routes should be defined in routes/api.php with appropriate middleware
